<?php
    ...
    foreach ($_POST as $key => $value){
        $_POST[$key]=mysqli_real_escape_string($con,htmlspecialchars($_POST[$key]));
    }
    foreach ($_REQUEST as $key => $value){
        $_REQUEST[$key]=mysqli_real_escape_string($con,htmlspecialchars($_REQUEST[$key]));
    }
    foreach ($_GET as $key => $value){
        $_GET[$key]=mysqli_real_escape_string($con,htmlspecialchars($_GET[$key]));
    }
